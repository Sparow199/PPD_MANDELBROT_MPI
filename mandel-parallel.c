...
/**************************************************************/
    ...
    segment_size = (y_max-y_min) / nb_process;

    init_picture ( &seg_pict, x_size, y_size / nb_process);
    ...
    compute (&seg_pict, n_iter, x_min, x_max, y_min + segment_size * ( nb_process - rank_process - 1 ), y_min + segment_size * ( nb_process - rank_process ));
